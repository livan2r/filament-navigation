...
>
    <div class="relative group">
        ...
        <div @class([
            ...
            <button
                x-init
                x-tooltip.raw.duration.0="{{__('filament-navigation::filament-navigation.items.edit')}}"
                type="button"
                wire:click="editItem('{{ $statePath }}')"
                class="p-1"
                title="{{__('filament-navigation::filament-navigation.items.edit')}}"
            >
                @svg('heroicon-o-pencil', 'w-3 h-3 text-gray-500 hover:text-gray-900')
            </button>
